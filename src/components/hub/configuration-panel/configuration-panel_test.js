...
const template = '<arcus-hub-configuration-panel {(hub)}="hub" />';
let vm;
let render;
let cleanupRender;

// ViewModel unit tests
describe('i2web/components/hub/arcus-hub-configuration-panel', () => {
  ...
  it('shall render on the page', () => {
    assert.equal($('arcus-hub-configuration-panel').length, 1);
  });
});
